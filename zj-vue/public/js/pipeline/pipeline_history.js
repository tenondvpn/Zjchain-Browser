            ...
            },
            {
                ...
                "render": function (data, type, full) {
                    ...
                    if (data == 0) {
                        ...
                        return '<h5 style="color:red" href="javascript:void(0);" taskid="' + full.task_id + '" runtime+"' + full.run_time + '" onclick=""   tid="' + full.task_id + '" type="button" class="hover-p" data-toggle="tooltip" data-placement="left">上游任务失败</h5>';
                    }
                }
            }, {
                "targets": [2],
            ...
            },
            {
                ...
                "render": function (data, type, full) {
                    /*            if (data == 0) {
                                  ...
                                  return '<button tid="'+full.task_id+'"type="button" class="hover-p btn btn-danger center-block" data-toggle="tooltip" data-placement="left">上游任务失败</button>';
                                  }*/
                    if (data == 0) {
                        ...
                        return '<h5 style="color:red" href="/pipeline/gettaskphoto/?pl_id=' + full.pl_id + '&runtime=' + full.run_time + '&taskname=' + full.task_name + '" taskid="' + full.task_id + '" runtime+"' + full.run_time + '" onclick="message(this)"   tid="' + full.task_id + '"type="button" class="hover-p" data-toggle="tooltip" data-placement="left">上游任务失败</h5>';
                    }
            ...
            if (data.prev[3]) {
                ...
                if (data.prev[3].length > 5) {
                    for (var i = 0; i < 5; i++) {
                        ...
                        message += "<span>对应DAG流名:" + data.prev[3][i].pipeline_name + "</span><br>" + "<span>对应任务名:" + data.prev[3][i].task_name + "</span><br>" + "<span>对应执行时间:" + data.prev[3][i].run_time + "</span><br><span>负责人:" + list + "</span></br>";
                ...
                if (data.prev[6].length > 5) {
                    for (var i = 0; i < 5; i++) {
                        ...
                        message += "<span>对应DAG流名:" + data.prev[6][i].pipeline_name + "</span><br><span>对应任务名:" + data.prev[6][i].task_name + "</span><br><span>对应执行时间:" + data.prev[6][i].run_time + "</span><br><span>负责人:" + list + "</span></br>";
                    }
                } else {
                ...
                if (data.prev[0]) {
                    if (data.prev[0].length > 5) {
                        for (var i = 0; i < 5; i++) {
                            ...
                            message += "<span>对应DAG流名:" + data.prev[0][i].pipeline_name + "</span><br><span>对应任务名:" + data.prev[0][i].task_name + "</span><br><span>对应执行间:" + data.prev[0][i].run_time + "</span><br><span>负责人:" + list + "</span><br>";
                        }
                    } else {
                        for (var i = 0; i < data.prev[0].length; i++) {
                            ...
                            message += "<span>获取等待中的任务信息如下:</span><br>";
                            message += "<span>对应DAG流名:" + data.prev[0][i].pipeline_name + "</span><br><span>对应任务名:" + data.prev[0][i].task_name + "</span><br><span>对应执行时间:" + data.prev[0][i].run_time + "</span><br><span>负责人" + list + "</span><br>";
                        }
                    }
                }
                else if (data.prev[5]) {
                    if (data.prev[5].length > 5) {
                        for (var i = 0; i < 5; i++) {
                            ...
                            message += "<span>对应DAG流名:" + data.prev[5][i].pipeline_name + "</span><br><span>对应任务名:" + data.prev[5][i].task_name + "</span><br><span>对应执行间:" + data.prev[5][i].run_time + "</span><br><span>负责人:" + list + "</span></br>";
                        }
                    } else {
                    ...
                    if (data.prev[1].length > 5) {
                        for (var i = 0; i < 5; i++) {
                            ...
                            message += "<span>对应DAG流名:" + data.prev[1][i].pipeline_name + "</span><br><span>对应任务名:" + data.prev[1][i].task_name + "</span><br><span>对应执行间:" + data.prev[1][i].run_time + "</span><br><span>负责人:" + list + "</span></br>";
                        }
                    } else {
