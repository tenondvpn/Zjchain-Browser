...
exchange_contarct_address = "000deab96c9e759daa3aff82b40e77cd615a41d9"
    ...
    if request.method == 'POST':
        try:
            ...
            if res.status_code != 200:
                ...
                print(res.json())
                des_str = res.text
                des_str='[{"id":"00","hash":"754344e9e3560b50709887b3c769033546c7adde267ce90ec948cadd22d171ae","owner":"44a5c714cb3f502fb77618a4a0353d96148fde7e","info":"","price":"01","start_time":"00","end_time":"01","buyers":[{"buyer":"0000000000000000000000000000000000000000","price":"00"}]}]'
                return JsonHttpResponse({'status': 0, 'msg': "ok", 'data': json.loads(des_str)})
        except Exception as ex:
            return JsonHttpResponse({'status': 1, 'msg': str(ex)})        